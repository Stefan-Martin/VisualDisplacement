...
if __name__ == '__main__':
    ...
    clahe = cv.createCLAHE(clipLimit=2.0, tileGridSize=(8,8)) #contrast-limited histogram equalization
    obj_points = []
    img_points = []
    ...
    for fn in img_names if debug_dir else []:
        ...
        np.savez("CameraCalibration",Cmtx=camera_matrix,distortion=dist_coefs)
